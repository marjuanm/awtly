...
MESSAGES = {
  ...
  "ALREADYERRORSFOUND":
    "Errores encontrados durante la ejecución, se ha creado / actualizado un archivo debug.log.\nRevise su archivo de depuración, ¿desea reportarlo?, por favor visite los siguientes enlaces:\n\n" + DEBUG_FILE_URLS,
  "INVALIDID":
