...
MESSAGES = {
  ...
  "NOGRATSTOOVERWRITEORDELETEFOLDER":
    "Acesso negado. Permissões insuficientes para substituir ou eliminar a pasta do projeto",
  "INVALIDPROJECTNAME":
    "O nome da pasta do projeto não deve conter extensões de arquivo.",
  "INVALIDTEMPLATENAME":
    "O nome da pasta do modelo não pode conter uma extensão de arquivo.",
  "TEMPLATENOTFOUND":
  ...
  "FOLDERPROJECTNAMENOTFOUND":
    "Projeto não encontrado",
  "PROJECTFILENOTFOUND": 
    "Arquivo de projeto não encontrado",
  "FILENOTFOUND": 
    "Arquivo não encontrado",
  "INVALIDCONFIGURATIONLINE": 
    "Linha inválida no arquivo de configuração",
  "EMPTYCONFIGURATIONKEY": 
    "Chave vazia no arquivo de configuração",
  "DUPLICATECONFIGURATIONKEY": 
      "Chave duplicada no arquivo de configuração",
